...
import { abi as NftMarketplaceABI, address as NftMarketplaceAddress } from "../utils/contracts/NftMarketplace.json";
import { abi as NFTABI, address as NFTAddress } from "../utils/contracts/NFT.json";
...
export const NFTContract = async (signerAddress: string,) => {
    return await contractProvider({
        contractABI: NFTABI,
...
export const listenForTransactionMine = async (transactionResponse: any, provider: ethers.BrowserProvider): Promise<any> => {
    return new Promise(() => {
